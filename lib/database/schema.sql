-- Rental Fleet UAE - Database Schema
-- Programmatic SEO Entity Management System

-- Create database if not exists
CREATE DATABASE IF NOT EXISTS rental_fleet_uae
  CHARACTER SET utf8mb4
  COLLATE utf8mb4_unicode_ci;

USE rental_fleet_uae;

-- ==================== Entities Table ====================
-- Main table for all programmatic entities (emirates, vehicles, services, intents)
...
-- Cache for generated page content to improve performance
...
-- Store content generation templates and variants
...
-- Track build performance and statistics
...
-- ==================== Blog Articles Table ====================
-- Store long-form blog content in the DB (SSG at build-time reads from here)
...
-- View for page generation queue (prioritized)
