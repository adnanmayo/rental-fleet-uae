          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                <a href={siteConfig.promotedSites.autycloud.url} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-700 underline" data-ga-event="cta_click" data-ga-label="autycloud_about_inline" data-ga-category="outbound">
                  AutyCloud
                </a>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-br from-blue-50 to-white border-2 border-blue-200 rounded-xl p-8">
              ...
              <a
                ...
                data-ga-label="autycloud_about_partners"
